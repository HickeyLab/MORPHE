...
EXPECTED_RUN_CONFIG_BY_MODE = {
    InferenceMode.INPAINTING: InpaintRunConfig,
    InferenceMode.GAPFILL: GapfillRunConfig,
    InferenceMode.OUTPAINTING: OutpaintRunConfig,
    InferenceMode.THREE_DIMENSIONAL_IMPUTATION: ThreeDimImputationRunConfig,
}